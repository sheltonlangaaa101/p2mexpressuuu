...
export const recentProducts = [
  { id: "1", name: "Casaco Oversize Linho", store: "Zara", image: "https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.zara.com/pt/pt/mulher-casacos-l1119.html", customerName: "Ana S.", purchaseDate: "Mai 2026" },
  { id: "2", name: "Vestido Midi Floral", store: "Mango", image: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&w=600&q=80", productUrl: "https://shop.mango.com/pt/mulher/vestidos", customerName: "Maria T.", purchaseDate: "Mai 2026" },
  { id: "3", name: "Ténis Air Max 2025", store: "Nike", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.nike.com/pt/w/sapatilhas-homem-6ealhzy7ok8", customerName: "João M.", purchaseDate: "Abr 2026" },
  { id: "4", name: "Conjunto Desportivo", store: "Adidas", image: "https://images.unsplash.com/photo-1556906781-9a412961a812?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.adidas.pt/treino-e-ginasio", customerName: "Carlos M.", purchaseDate: "Abr 2026" },
  { id: "5", name: "Mala Tiracolo Couro", store: "Stradivarius", image: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.stradivarius.com/pt/mulher/acessorios/bolsas", customerName: "Fatima A.", purchaseDate: "Mar 2026" },
  { id: "6", name: "Kit Maquilhagem Primavera", store: "Kiko Milano", image: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.kikocosmetics.com/pt-pt/maquilhagem", customerName: "Luisa C.", purchaseDate: "Mar 2026" },
  { id: "7", name: "Jeans Wide Leg", store: "Bershka", image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=600&q=80", productUrl: "https://www.bershka.com/pt/mulher/roupa/jeans", customerName: "Pedro S.", purchaseDate: "Fev 2026" },
  { id: "8", name: "Blazer Estruturado", store: "H&M", image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=600&q=80", productUrl: "https://www2.hm.com/pt_pt/mulher/produtos/fatos-e-blazers.html", customerName: "Diana R.", purchaseDate: "Jan 2026" },
];

export const sampleOrders: Record<string, { id: string; trackingCode: string; customerName: string; status: string; statusDescription: string; createdAt: string; updatedAt: string; estimatedDelivery?: string }> = {
  "NIA2024001": { id: "1", trackingCode: "NIA2024001", customerName: "Cliente Teste", status: "delivered", statusDescription: "Encomenda entregue com sucesso", createdAt: "2024-11-01", updatedAt: "2024-11-06", estimatedDelivery: "2024-11-06" },
  "NIA2024002": { id: "2", trackingCode: "NIA2024002", customerName: "Cliente Demo", status: "in_transit", statusDescription: "Em trânsito para Moçambique", createdAt: "2024-11-20", updatedAt: "2024-11-22", estimatedDelivery: "2024-11-27" },
};
